...
(function(window, document, undefined) {
    ...
    function slideListener(ctx, slideElement, pickerElement) {
        return function(evt) {
            ...
            // We set the picker color to selected hue (max saturation and value)
            pickerElement.style.backgroundColor = hsv2rgb({ h: ctx.h, s: 1, v: 1 }).hex;
            // The callback color is the actual selected color
    ...
    */
    ...
    ColorPicker.positionIndicators = function(slideIndicator, pickerIndicator, mouseSlide, mousePicker) {
        ...
        if (mouseSlide) {
            // Disable the following lines to keep the picker indicator in the same spot:
